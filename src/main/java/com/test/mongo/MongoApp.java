...
import com.test.mongo.config.ApplicationProperties;
import com.test.mongo.config.DefaultProfileUtil;
...
public class MongoApp {
    ...
    public MongoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MongoApp.class);
